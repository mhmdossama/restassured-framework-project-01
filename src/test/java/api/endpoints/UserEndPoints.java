...
public class UserEndPoints {
    ...
    // Create User
    public static String createUser = Routes.createUser;
    ...
    // Get User
    public static String getUserByName = Routes.getUserByName;
    ...
    // Update User
    public static String updateUser = Routes.updateUser;
    ...
    // Delete User
    public static String deleteUser = Routes.deleteUser;
